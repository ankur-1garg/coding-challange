"""
Django settings for product_prj project.
...
WSGI_APPLICATION = 'product_prj.wsgi.application'
...
# Add Snowflake specific settings
SNOWFLAKE_PRIVATE_KEY_PATH = None  # Add if using key pair authentication
SNOWFLAKE_PRIVATE_KEY_PASSPHRASE = None  # Add if using key pair authentication
